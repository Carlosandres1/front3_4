function traerInformacionClientes(){
    $.ajax({
    url:"http://129.151.116.146:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionClientes(){
    ...
    $.ajax({
        ...
        url:"http://129.151.116.146:8080/api/Client/save",
...
function actualizarInformacionClientes(idElemento){
    ...
    $.ajax({
        url:"http://129.151.116.146:8080/api/Client/update",
        type:"PUT",
        data:dataToSend,
...
function borrarClientes(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.116.146:8080/api/Client/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
